...
OUT_DIR = "data"
OUT_CSV = os.path.join(OUT_DIR, "mr1_year_splits_hold5.csv")

# Choose a few candidates from your sweep
...
def main():
    ...
    # Print a quick view focusing on 2018/2020/2022/2025 (common stress years)
    focus_years = [2018, 2020, 2022, 2025]
    view = out[out["year"].isin(focus_years)].sort_values(["ret3d_max","year"])
    print("MR-1 year focus (hold=5D, net):")
