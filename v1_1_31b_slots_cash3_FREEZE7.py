...
TP_RISKOFF_SCALE = 1.0   # used only if TP_GATE_MODE == "reduce"
...
def main():
    ...
    for di, d in enumerate(dates):
        ...
        for strat, picks in [("TP_v2", tp_pick), ("MR_1A", mr_pick), ("EB_1A", eb_pick)]:
            ...
            budgets[strat] = base
            if day == pd.Timestamp("2022-06-02"):
                print(f"[DBG] {day.date()} risk_on={risk_on} dd_entry={dd_entry} tp_scale={tp_dd_scale}")
